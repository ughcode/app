...
(function () {
  ...
  if (typeof window !== 'undefined') { // we're in a browser environment
  ...
  } else if (typeof module !== 'undefined') { // we're in command line environment

    module.exports = {
      weatherForZipCodes : weatherForZipCodes
    };

    // Need to get XMLHttpRequest from external module
